...
namespace IGT.PNRProcessingService.GWSConnection.GWS.XmlSelectService {
    using System;
    ...
    public partial class XmlSelect : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public XmlSelect() {
            this.Url = global::IGT.PNRProcessingService.GWSConnection.Properties.Settings.Default.IGT_PNRProcessingService_GWSConnection_GWS_XmlSelectService_XmlSelect;
        ...
        /// <remarks/>
        public void SubmitTerminalTransactionAsync(string Profile, string Token, string Request, string IntermediateResponse) {
            this.SubmitTerminalTransactionAsync(Profile, Token, Request, IntermediateResponse, null);
        }
        
        /// <remarks/>
        public void SubmitTerminalTransactionAsync(string Profile, string Token, string Request, string IntermediateResponse, object userState) {
