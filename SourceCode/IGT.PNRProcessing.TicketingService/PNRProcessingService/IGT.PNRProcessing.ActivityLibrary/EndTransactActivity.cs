...
namespace IGT.PNRProcessing.ActivityLibrary
{
    ...
    public sealed class EndTransactActivity : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            XmlElement nextPNRXml = objFareProcess.EndTransactRetrieveNextPNR(objHAP, strSession);

            context.SetValue(PNRXml, nextPNRXml);
        }
    }
}
